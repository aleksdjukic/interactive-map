...
@section('title', 'ADMIN | Izmjena Praćenog predmeta korupcije')
@section('content_header')
    <h1>Izmjena Praćenog predmeta korupcije [{{ strtoupper(Request::get('language')) }}]</h1>
@stop
@section('content')
    @include('includes.sessions')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Izmjeni praćeni predmeti korupcije </h3>
        </div>

        <div class="card-body">
{{--            <form id="form" action="{{ route('praceni-predmeti-korupcije.update', $pkk->id) }}" method="POST"--}}
{{--                  enctype="multipart/form-data"--}}
{{--                  class="wizard-big">--}}
                <form id="form" action="{{ url('admin/praceni-predmeti-korupcije/'.$pkk->id.'?language='.Request::get('language').'') }}" method="POST"
                      enctype="multipart/form-data"
                      class="wizard-big">
                @csrf
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input id="broj_optuzenih_u_predmetu" name="broj_optuzenih_u_predmetu"
                                       value="{{ $pkk->broj_optuzenih_u_predmetu }}"
                                        type="number"
                                       class="form-control required">
                            </div>
                            <div class="form-group">
                                ...
                                <input id="sud_pred_kojim_se_vodi_postupak" name="sud_pred_kojim_se_vodi_postupak"
                                       value="{{ $pkk->sud_pred_kojim_se_vodi_postupak }}"
                                       type="text"
                                       class="form-control required">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="tuzilastvo" name="tuzilastvo" type="text"
                                        class="form-control required">
                                    <option value="">Izaberite</option>
                                    @foreach($tuzilastvo as $t)
                                        <option
                                            value="{{ $t->id }}" {{$pkk->tuzilastvo == $t->id ? 'selected' : ''}}>{{ $t->naziv }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <input id="vrijeme_izvrsenja_djela" name="vrijeme_izvrsenja_djela"
                                       value="{{ $pkk->vrijeme_izvrsenja_djela }}"
                                        type="text"
                                       class="form-control required">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="datum_podnosenja_krivicne_prijave" name="datum_podnosenja_krivicne_prijave"
                                        type="text"
                                       value="{{ $pkk->datum_podnosenja_krivicne_prijave }}"
                                       class="form-control required">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="datum_donosenja_naredbe_o_sprovodjenju_istrage"
                                       value="{{ $pkk->datum_donosenja_naredbe_o_sprovodjenju_istrage }}"
                            ...
                            <div class="form-group">
                                ...
                                <input id="preduzimanje_posebnih_istraznih_radnji"
                                       ...
                                       value="{{ $pkk->preduzimanje_posebnih_istraznih_radnji }}"
                                        type="text"
                                       class="form-control required">
                            </div>
                            <div class="form-group">
                                ...
                                <input id="datum_podizanja_optuznice" name="datum_podizanja_optuznice" type="text"
                                       value="{{ $pkk->datum_podizanja_optuznice }}"
                                       class="form-control required">
                            </div>
                            <div class="form-group">
                                ...
                                <input id="datum_potvrdjivanja_optuznice" name="datum_potvrdjivanja_optuznice"
                                        type="text"
                                       value="{{ $pkk->datum_potvrdjivanja_optuznice }}"
                                       class="form-control required">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="datum_donosenja_prvostepene_presude"
                                       ...
                                       value="{{ $pkk->datum_donosenja_prvostepene_presude }}"
                                        type="text"
                                       class="form-control required">
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input id="postupajuci_sud" name="postupajuci_sud" value="{{ $pkk->postupajuci_sud }}"
                                        type="text"
                                       class="form-control required">
                            </div>
                            <div class="form-group">
                                ...
                                <input id="postupajuce_tuzilastvo" name="postupajuce_tuzilastvo"
                                       value="{{ $pkk->postupajuce_tuzilastvo }}"
                                        type="text"
                                       class="form-control required">
                            </div>
                            <div class="form-group">
                                ...
                                <input id="naziv_krivicnog_djela_izrecenim" name="naziv_krivicnog_djela_izrecenim"
                                       type="text" value="{{ $pkk->naziv_krivicnog_djela_izrecenim }}"
                                       class="form-control required">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="zaprijecena_sankcija_za_predmetno_krivicno_djelo_shodno_kz"
                                       ...
                                       type="text"
                                       value="{{ $pkk->zaprijecena_sankcija_za_predmetno_krivicno_djelo_shodno_kz }}"
                                       class="form-control">
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="vrsta_i_visina_izrecene_sankcije_da_li_je_sankcija_ublazena_izm"
                                       name="vrsta_i_visina_izrecene_sankcije_da_li_je_sankcija_ublazena_izm"
                                        type="text"
                                       value="{{ $pkk->vrsta_i_visina_izrecene_sankcije_da_li_je_sankcija_ublazena_izm }}"
                                       class="form-control">
                            </div>
                            <div class="form-group">
                                ...
                                <input id="da_li_je_presudom_izrecena_sigurnosna_mjera_zabrane_vrsenja_paif"
                                       name="da_li_je_presudom_izrecena_sigurnosna_mjera_zabrane_vrsenja_paif"
                                        type="text"
                                       value="{{ $pkk->da_li_je_presudom_izrecena_sigurnosna_mjera_zabrane_vrsenja_paif }}"
                                       class="form-control">
                            </div>

                            <div class="form-group">
                                <label>Da li je izrečena mjera oduzimanje imovinske koristi pribavljene krivičnim djelom
                                    </label>
                                <input id="da_li_je_izrecena_mjera_oduzimanje_imovinske_koristi_pkd"
                                       ...
                                       value="{{ $pkk->da_li_je_izrecena_mjera_oduzimanje_imovinske_koristi_pkd }}"
                                        type="text"
                                       class="form-control">
                            </div>
                            <div class="form-group">
                                ...
                                <input id="da_li_je_tuzilastvo_izjavilo_zalbu_na_prvostepenu_presudu"
                                       value="{{ $pkk->da_li_je_tuzilastvo_izjavilo_zalbu_na_prvostepenu_presudu }}"
